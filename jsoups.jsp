<%-- 
    Document   : jsoup
    Created on : Mar 27, 2018, 5:04:58 PM
    Author     : Dell
--%>
...
<body style="overflow-x: hidden">
        ...
        <div class="row">
            ...
            String urls = "https://aajtak.intoday.in/topic/"+keywords+".html";
      Document documents = Jsoup.connect(urls).get();

      for(int i=0;i<10;i++)
      {
          Element linkdss = documents.select("h3.scc_r a").get(i);
      //out.println("Heading :"+linkdss.text()+"<br/>");
      
      Element link = documents.select("h3.scc_r").get(i);
      //out.println("Heading :<a href='"+linkdss.attr("href")+"'>"+link.text()+"</a>"+"<br/>");
      
      Element links = documents.select("cite").get(i);
      //out.println("Date :"+links.text()+"<br/>");
      
      Element linkss = documents.select("span.scc_st").get(i);
       //out.println("Text :"+linkss.text()+"<br/>");
       
       Element linkds = documents.select("div.scc_img_g img").get(i);
       //out.print("<img src='"+linkds.attr("src") +"'>");
          %>
                ...
                <div class="thumbnail">
                    <div class="row">
                        <div class="col-md-3">
                            <%out.print("<img src='"+linkds.attr("src") +"' id='myimage'>");%>
                            
                        </div>
                        <div class="col-md-9" id="myheading">
                            <h5 id="updatetime">Last updated: <span id="date"><%=links.text()%></span></h5>
                            <h3><%out.println("<a href='"+linkdss.attr("href")+"'>"+link.text()+"</a>"+"<br/>");%></h3>
                            <div class="show-read-more"><%=linkss.text()%>
                            </div>
                            <br/>
                            <div id="author" style="text-indent: 20px;">
                                <b>Source Credit: <a href="https://aajtak.intoday.in/">aajtak</a></b>
                            </div>
