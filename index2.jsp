...
<body style="margin:0;">
        ...
        <!--Header starts-->
            ...
            <div class="row" style="background-color:#00264d;padding:10px;text-align: center;color:white;font-size:20px;">
        ...
        <!--Content begins here-->
        <div id="contentbody" style="margin-left: 5px;">
            <!--carousel starts-->
                ...
                <div id="first-slider" class="">
                    <div id="carousel-example-generic" class="carousel slide carousel-fade">
                        ...
                        <div class="col-md-5 text-right">
                            <img style="max-width: 200px;" data-animation="animated zoomInLeft" src="http://im.rediff.com/money/2015/jan/05tribal.jpg"
                            class="">
                        </div>
                    </div>
                </div>
...
<div class="container-fluid">
        <div class="row">
            ...
            String msql="select * from articles order by date desc";
                ...
                <div class="thumbnail">
                    <div class="row">
                        ...
                        <div class="col-md-9" id="myheading">
                            <h5 id="updatetime">Last updated: <span id="date"><%=dt%></span></h5>
                            <h3><%=heading%></h3>
            ...
            if(rss.next())
            {
                ...
                <form action="addLike" method="post">
                                    ...
                                    } catch(Exception ex)
                            {
                                ...
                                <div class="label label-default" style="padding:5px;">1000</div>                                
