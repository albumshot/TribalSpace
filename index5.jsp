...
<body style="overflow-x: hidden">
    ...
    <form action="" name="frm" method="post">
        <table cellspacing="10" cellpadding="5" style="margin-left: 5%;margin-top: -2%;">
            <%
                String val;
            if(request.getParameter("name")!=null)
            {
                ...
                val="";
            %>
                                          <input list="allNames" name="names"  id="name" placeholder="Enter Tags" required pattern="[A-Za-z-*+ ]+" title="Bookname should be in alphabets letter" onchange="submits()" onended="submits()" autocomplete="off">
  <datalist id="allNames">
     ...
     %>
            ...
            <div class="col-md-3" style="margin-right: 0px;">
                <div style="margin-top: 10px;">
                    ...
                    <div style="text-align: center;">
                        ...
                        if(session.getAttribute("uname")==null){
                        %>
                        <div class="btn btn-lg" id="pubbtn" style="background-color:red;color:white;font-weight: bold;padding:10px;box-shadow: 5px 5px 3px rgb(200,200,200);"><a href="login">Publish</a></div>
                            <%} else {%>
                            <div class="btn btn-lg" id="pubbtn" style="background-color:red;color:white;font-weight: bold;padding:10px;box-shadow: 5px 5px 3px rgb(200,200,200);"><a href="home">Publish</a></div>
                                <% } %>
                ...
                <div class="col-md-3">
                    <form action="jsoup.jsp" method="post">
                        <input type="text" name="keywords" placeholder="Aaj Tak">
        ...
        <form action="toi.jsp" method="post">
            <input type="text" name="keywords" placeholder="Times of India">
            <input type="submit" value="search">
        </form>
                </div>
