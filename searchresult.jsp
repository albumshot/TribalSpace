...
<body style="overflow-x: hidden">
        ...
        <table >
            ...
            if(request.getParameter("name")!=null)
            {
                ...
                val="";
            %>
            <input list="allNames" name="name" size="30" value="<%=val%>" id="name" placeholder="Enter Tags" class="form-control" required pattern="[A-Za-z-*+ ]+">
...
<script>
        ...
        <div class="row">
            ...
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/stddb","root","dinesh33");
            String msql="select * from articles where tags='"+tags+"'";
            PreparedStatement psmt=con.prepareStatement(msql);
            ResultSet rs=psmt.executeQuery();
